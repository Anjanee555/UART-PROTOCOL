...
This project implements a fully synthesizable UART (Universal Asynchronous Receiver Transmitter) 
communication system using Verilog HDL.
The design demonstrates reliable asynchronous serial communication between transmitter and receiver, 
including baud rate generation and FIFO-based buffering for stable data transfer.
